    ...
    <div className="max-h-[94vh] flex-1 overflow-y-scroll px-5 pb-32 pt-10 md:px-20">
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 xl:grid-cols-2">
        ...
        <CertificateItem
          ...
          description="A 4-hour long programming contest organized by OBSS which consisted of problems assessing the participants' knowledge of data structures and algorithms, research skills, and problem solving related to real-life business applications. I ranked 2nd from my university."
          date="October 2023"
